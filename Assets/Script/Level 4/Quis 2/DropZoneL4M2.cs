...
public class DropZoneL4M2 : MonoBehaviour
{
    ...
    public DropZoneL4M2[] allDropZonesToCheck;
    ...
    public int GetPlacedID()
    {
        ...
        {
            var drag = placedPuzzlePiece.GetComponent<DragAndDropL4M2>();
            if (drag != null)
    ...
    private void CheckAllDropZonesIfReady()
    {
        ...
        foreach (DropZoneL4M2 dz in allDropZonesToCheck)
        {
            if (!dz.IsOccupied())
        ...
        NpcControllerL4M2 controller = FindObjectOfType<NpcControllerL4M2>();
        if (controller != null)
        {
