...
public class DropZoneL2M2 : MonoBehaviour
{
    private GameObject placedPuzzlePiece;

    [Header("DropZones yang akan dijumlahkan")]
    public DropZoneL2M2[] linkedDropZones; // Diatur dari Inspector
    ...
    public int GetPlacedPuzzleID()
    {
        ...
        {
            DragAndDropL2M2 script = placedPuzzlePiece.GetComponent<DragAndDropL2M2>();
            if (script != null)
    ...
    bool AllDropZonesOccupied()
    {
        ...
        foreach (DropZoneL2M2 zone in linkedDropZones)
        {
    ...
    void CheckSum()
    {
        ...
        AnnisaControllerL2M2 controller = FindObjectOfType<AnnisaControllerL2M2>();
        if (controller != null)
        {
        ...
        {
            Debug.LogWarning("⚠️ Controller (AnnisaControllerL2M2) tidak ditemukan di scene!");
        }
    }
