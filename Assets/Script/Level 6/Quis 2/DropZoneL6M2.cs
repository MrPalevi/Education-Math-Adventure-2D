...
public class DropZoneL6M2 : MonoBehaviour
{
    ...
    public DropZoneL6M2[] allDropZonesToCheck;
    ...
    public int GetPlacedID()
    {
        ...
        {
            var drag = placedPuzzlePiece.GetComponent<DragAndDropL6M2>();
            if (drag != null)
    ...
    private void CheckAllDropZonesIfReady()
    {
        ...
        foreach (DropZoneL6M2 dz in allDropZonesToCheck)
        {
            if (!dz.IsOccupied())
        ...
        NpcControllerL6M2 controller = FindObjectOfType<NpcControllerL6M2>();
        if (controller != null)
        {
