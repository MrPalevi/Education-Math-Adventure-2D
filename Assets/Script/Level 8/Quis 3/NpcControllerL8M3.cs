...
public class NpcControllerL8M3 : MonoBehaviour
{
    ...
    public GameObject PaAsepChatBoxPanelComplet;
    ...
    public string namaPlayerPrefsScore = "L4M3"; 

    [Header("Pengaturan Posisi ChestBox")]
    public Vector2 offsetChestBox = new Vector2(2f, 0f); 
    ...
    void Start()
    {
        ...
        PaAsepChatBoxPanelComplet?.SetActive(false);
        Stop?.SetActive(true);
    ...
    IEnumerator ShowFeedbackThenComplete(bool isCorrect)
    {
        ...
        PaAsepChatBoxPanelComplet?.SetActive(true);
        controllerPanel?.SetActive(true);
    ...
    void ShowChat()
    {
        ...
        if (isMissionCompleted && PaAsepChatBoxPanelComplet != null)
        {
            chatBoxUI?.SetActive(false);
            controllerPanel?.SetActive(true);
            PaAsepChatBoxPanelComplet.SetActive(true);
